...
function Withdraw() {
    ...
    const choice = () => {
            accountSelect = choiceRef.current.value
    ...
    async function withDraw(e) {
        ...
        try{
            setError('')
            setLoading(true)
            await withdraw(firstNameRef.current.value, lastNameRef.current.value, emailRef.current.value, walletRef.current.value, appRef.current.value, earnTypeRef.current.value, earningRef.current.value)
            setSuccess('Sent! You will Recieve it within 24 hours!!!')
                    ...
                    <div class="card">
                        ...
                        <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                            ...
                            >
                                ...
                                <span class="d-none d-lg-block"><p className="with">Withdrawal Info</p></span>
                            </a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="">
                                <div class="col-lg-8">
                                <h4 class="mt-2">Withdrawal information</h4>

                                <p class="text-muted mb-4">
                                    Fill the form below Correctly in order to avoid complications
                                    and Loss
                                </p>
                                <div className="text-danger">{error}</div>
                                <div className="text-success">{success}</div>

                                <form onChange={choice} className="withdraw-form">
                                    <div class="">
                                    <div class="">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        >
                                            <option
                                            value="0"
                                            data-select2-id="select2-data-3-jk3y"
                                            >
                                            Select Country
                                            </option>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <label for="billing" class="form-label"
                                            >Withdraw Option<span class="text-danger">*</span></label>
                                        <select
                                            data-toggle="select2"
                                            ...
                                            ref={choiceRef}
                                        >
                                            <option value= '0' > Withdrawal Option</option>
