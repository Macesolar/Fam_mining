    ...
    async function minednumber () {
        ...
        switch (number) {
            case 300000:
                ...
                setTimeout(() => {
                    setMessage('CONGRATS!! YOU MINED ETH 50.20!!!')
                    stop()
            ...
            case 7000000:
                ...
                setTimeout(() => {
                    setMessage('CONGRATS!!! YOU MINED ETH 500.20!!!')
                    stop()
            ...
            default:
                ...
                setTimeout(() => {
                    setMessage('YOU MINED ETH 0.00001!!!')
                    stop()
                    setShow(true)
