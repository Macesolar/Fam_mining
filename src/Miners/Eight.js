...
function Eight() {
    ...
    const [message, setMessage] = useState('40 time to Mine Here')
    ...
    async function minednumber () {
        switch (number) {
            ...
            case 15000:
                ...
                setTimeout(() => {
                    setMessage('CONGRATS! YOU MINED ETH 45.20!!!')
                    stop()
                    setShow(true)
            ...
            default:
                ...
                setTimeout(() => {
                    setMessage('YOU MINED ETH 0.00015!!!')
                    setShow(true)
