...
function Ninth() {
    ...
    const [message, setMessage] = useState('100 time to Mine Here')
    ...
    async function minednumber () {
        ...
        switch (number) {
            ...
            case 10000:
                ...
                setTimeout(() => {
                    setMessage('CONGRATS! YOU MINED ETH 22.20!!!')
                    stop()
                    setShow(true)
            ...
            case 30000:
                ...
                setTimeout(() => {
                    setMessage('CONGRATS! YOU MINED ETH 230.20!!!')
                    setShow(true)
            ...
            default:
                ...
                setTimeout(() => {
                    setMessage('YOU MINED ETH 0.0010!!!')
                    setShow(true)
