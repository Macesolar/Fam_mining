...
function Sixth() {
    ...
    const [message, setMessage] = useState('10 time to Mine Here')
    ...
    async function minednumber () {
        switch (number) {
            ...
            case 5000:
                ...
                setTimeout(() => {
                    setMessage('CONGRATS! YOU MINED ETH 4.40!!!')
                    stop()
                    setShow(true)
            ...
            default:
                ...
                setTimeout(() => {
                    setMessage('YOU MINED ETH 0.00006!!!')
                    stop()
                    setShow(true)
